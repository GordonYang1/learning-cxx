...
int main(int argc, char **argv) {
    ...
    // TODO: 补全三个类型的大小
    static_assert(sizeof(X) == 4, "There is an int in X");      // 一个int，4字节
    static_assert(sizeof(A) == 4, "There is an int in A");      // 一个int，4字节  
    static_assert(sizeof(B) == 8, "B is an A with an X");       // 继承A(4字节) + 成员X(4字节) = 8字节
